...
public interface InpatientAggregationRepoIntf {
	...
	.append("  SUM(CAST(cd.paidAmount AS        DOUBLE)) AS paidAmount,")
	...
	.append("  cd.mbrIdentifier,")
	.append("  cd.prncplPrcdrCd,")
	.append("  cd.prncplPrcdrCdDate,cd.patientStatusLkpcd,cd.patientGender, cd.patientBirthDate ,cd.patientZip, ")
	.append("  cd.de1,")
	.append("  cd.de1_poa,")
	.append("  cd.de2,")
	.append("  cd.de2_poa,")
