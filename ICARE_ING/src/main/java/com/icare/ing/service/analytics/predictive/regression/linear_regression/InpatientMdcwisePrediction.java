...
//		return (T) trainValidationSplitModel;
		...
		if(ArrayUtils.contains(trainingDataConverted.columns(),"d1"))
		{
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d1"});
		...
		if(ArrayUtils.contains(trainingDataConverted.columns(),"d1_poa"))
		{
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d1_poa"});
		...
		if(ArrayUtils.contains(trainingDataConverted.columns(),"d2"))
		{
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d2"});	
		...
		if(ArrayUtils.contains(trainingDataConverted.columns(),"d2_poa"))
		{
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d2_poa"});	
		...
		if(ArrayUtils.contains(trainingDataConverted.columns(),"d3"))
		{
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d3"});	
		...
		if(ArrayUtils.contains(trainingDataConverted.columns(),"d3_poa"))
		{
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d3_poa"});
		...
		if(ArrayUtils.contains(trainingDataConverted.columns(),"d4"))
		{
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d4"});
		...
		if(ArrayUtils.contains(trainingDataConverted.columns(),"d4_poa"))
		{
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d4_poa"});
		...
		if(ArrayUtils.contains(trainingDataConverted.columns(),"d5"))
		{
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d5"});
		...
		if(ArrayUtils.contains(trainingDataConverted.columns(),"d5_poa"))
		{
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d5_poa"});
		...
		if(ArrayUtils.contains(trainingDataConverted.columns(),"d6"))
		{
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d6"});
		...
		if(ArrayUtils.contains(trainingDataConverted.columns(),"d6_poa"))
		{
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d6_poa"});
		...
		if(ArrayUtils.contains(trainingDataConverted.columns(),"d7"))
		{
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d7"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d7_poa"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d8"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d8_poa"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d9"});
	...
	//		assemblers.add("d9");
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d9_poa"});
	...
	//		assemblers.add("d9_poa");
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d10"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d10_poa"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d11"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d11_poa"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d12"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d12_poa"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d13"});
	...
	//		assemblers.add("d13");
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d13_poa"});
...
//			assemblers.add("d13_poa");
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d14"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d14_poa"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d15"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d15_poa"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d16"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d16_poa"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d17"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d17_poa"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d18"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d18_poa"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d19"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d19_poa"});
	...
	//		assemblers.add("d19_poa");
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d20"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d20_poa"});
...
//			assemblers.add("d20_poa");
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d21"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d21_poa"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d22"});
	...
	//		assemblers.add("d22");
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d22_poa"});
	...
	//		assemblers.add("d22_poa");
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d23"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d23_poa"});
	...
	//		assemblers.add("d23_poa");
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d24"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"d24_poa"});
	...
	//		assemblers.add("d24_poa");
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p1"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p2"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p3"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p4"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p5"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p6"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p7"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p8"});
		...
		{		
			...
			if(null!=d1Max && !d1Max.isEmpty() && d1Max.size()>1 && null!=d1Max.get(1).getAs("p9"))
			{
				...
				trainingDataConverted.na().fill(d1MaxValue, new String[] {"p9"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p10"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p11"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p12"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p13"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p14"});
	...
	//		assemblers.add("p14");
		...
		{		
			...
			if(null!=d1Max && !d1Max.isEmpty() && d1Max.size()>1 && null!=d1Max.get(1).getAs("p15"))
			{
				...
				trainingDataConverted.na().fill(d1MaxValue, new String[] {"p15"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p16"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p17"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p18"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p19"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p20"});
	...
	//		assemblers.add("p20");
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p21"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p22"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p23"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"p24"});
	...
	//		assemblers.add("p24");
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"admtDiagCd"});
		...
		{		
			Row d1Max = sparkSession.sql("SELECT admtDiagCdPoa, COUNT(admtDiagCdPoa) as d1_ct from TrainingTable group by admtDiagCdPoa order by d1_ct desc").first();
			String d1MaxValue = d1Max.getAs("admtDiagCdPoa");
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"admtDiagCdPoa"});
		...
		{		
			Row d1Max = sparkSession.sql("SELECT prncplDgnsCd, COUNT(prncplDgnsCd) as d1_ct from TrainingTable group by prncplDgnsCd order by d1_ct desc").first();
			String d1MaxValue = d1Max.getAs("prncplDgnsCd");
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"prncplDgnsCd"});
	...
	//		assemblers.add("prncplDgnsCd");
		...
		{		
			...
			if(null!=d1Max)
			{
				...
				{
					trainingDataConverted.na().fill(d1MaxValue, new String[] {"prncplDgnsPoa"});
		...
		{		
			...
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"prncplPrcdrCd"});
	...
	//		assemblers.add("prncplPrcdrCd");
		...
		{		
			Row d1Max = sparkSession.sql("SELECT patientStatusLkpcd, COUNT(patientStatusLkpcd) as d1_ct from TrainingTable group by patientStatusLkpcd order by d1_ct desc").first();
			System.out.println("patientStatusLkpcd:"+d1Max);
			String d1MaxValue = d1Max.getAs("patientStatusLkpcd");
			trainingDataConverted.na().fill(d1MaxValue, new String[] {"patientStatusLkpcd"});
