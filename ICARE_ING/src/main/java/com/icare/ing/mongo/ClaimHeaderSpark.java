...
//    implicitDS.show();
    ...
    Dataset<com.icare.common.dto.CD> explicitDS = dd.toDS(com.icare.common.dto.CD.class);
...
//    Dataset<Row> dts =sts.select(billedAmount.cast("int"),prcdrCode);
    ...
    Dataset<Row> centenarians = spark.sql("select sum(s.billedAmount as int)) from header c ,line s");
    centenarians.show();
