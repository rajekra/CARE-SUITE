...
/**
 * The Class ClmLnRunError.
 */
public class ClmLnRunError implements Serializable {
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;
	
	/** The clm ln run error sid. */
	private long clmLnRunErrorSid;
	...
	/**
	 * Instantiates a new clm ln run error.
	 */
	public ClmLnRunError() {
	}

	/**
	 * Gets the clm ln run error sid.
	 *
	 * @return the clm ln run error sid
	 */
	public long getClmLnRunErrorSid() {
		return clmLnRunErrorSid;
	}

	/**
	 * Sets the clm ln run error sid.
	 *
	 * @param clmLnRunErrorSid the new clm ln run error sid
	 */
	public void setClmLnRunErrorSid(long clmLnRunErrorSid) {
		this.clmLnRunErrorSid = clmLnRunErrorSid;
	}
