...
/**
 * The Class ClmLnAttachment.
 */
public class ClmLnAttachment implements Serializable {
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;
	
	/** The clm ln attachment sid. */
	private long clmLnAttachmentSid;
	...
	/**
	 * Instantiates a new clm ln attachment.
	 */
	public ClmLnAttachment() {
	}

	/**
	 * Gets the clm ln attachment sid.
	 *
	 * @return the clm ln attachment sid
	 */
	public long getClmLnAttachmentSid() {
		return clmLnAttachmentSid;
	}

	/**
	 * Sets the clm ln attachment sid.
	 *
	 * @param clmLnAttachmentSid the new clm ln attachment sid
	 */
	public void setClmLnAttachmentSid(long clmLnAttachmentSid) {
		this.clmLnAttachmentSid = clmLnAttachmentSid;
	}
