 ...
 */
//
@JsonRootName(value = "ClaimInformation")
public class ClaimHeader implements Serializable {
	...
	private String patientZipCode;
								  ...
								  // Temporarily adding which is not set by X12	
	private BigDecimal programCid = new BigDecimal(1);
	...
	@JsonProperty("BillingProviderZipCode")
	private String blngPrvdrLctnZipCode;
	
	@JsonProperty("ServicingProviderZipCode")
	private String srvcngPrvdrLctnZipCode;
	
	@JsonProperty("BillingProviderTaxId")
	private String blngPrvdrTaxId;
	
	@JsonProperty("BillingProviderTaxIdQualifier")
	private String blngPrvdrTaxIdQlfr;
	...
	@JsonManagedReference
	@JsonProperty("HeaderAccidentInformation")
	private Set<ClmHdrAcdntLctnRltdCaus> clmHdrAcdntLctnRltdCauses;
	
	@JsonManagedReference
	@JsonProperty("HeaderHospitalAdmissionInformation")
...
//	private Set<ClmHdrCutback> clmHdrCutbacks;
	...
	@JsonManagedReference
	@JsonProperty("HeaderDatesInformation")
...
//	private Set<ClmHdrHptlPcgInptnt> clmHdrHptlPcgInptnts;
	...
	@JsonManagedReference
	@JsonDeserialize(as=LinkedHashSet.class)
	@JsonProperty("HeaderOccuranceInformation")
	private Set<ClmHdrOccurrenceDetail> clmHdrOccurrenceDetails;

	@JsonManagedReference
	@JsonDeserialize(as=LinkedHashSet.class)
	@JsonProperty("HeaderOtherPayerAdjudicationInformation")
	private Set<ClmHdrOtherPayerDtl> clmHdrOtherPayerDtls;
	
	@JsonManagedReference
	@JsonDeserialize(as=LinkedHashSet.class)
	@JsonProperty("HeaderClaimPaymentRemarkInformation")
...
//	private Set<ClmHdrOthPyrAdjDtl> clmHdrOthPyrAdjDtls;
	...
	@JsonManagedReference
	@JsonProperty("HeaderReferenceInformation")
...
//	private Set<ClmLnHptlPcgOutptnt> clmLnHptlPcgOutptnts;
	...
	@JsonManagedReference
	@JsonProperty("HeaderNoteInformation")
	private List<HtClmHdrNote> htClmHdrNotes;
	
	public ClaimHeader() {
	}
	
	public String getClaimSubmitterID() {
		return claimSubmitterID;
	}

	public void setClaimSubmitterID(String claimSubmitterID) {
		this.claimSubmitterID = claimSubmitterID;
	}
...
//	}
	...
	public ClmSbmtr getClmSbmtr() {
		return clmSbmtr;
	}

	public void setClmSbmtr(ClmSbmtr clmSbmtr) {
		this.clmSbmtr = clmSbmtr;
	}
	...
	public String toString() {
		return "ClaimHeader [payerId=" + payerId + ", claimSubmitterID="
				+ claimSubmitterID + ", patientZipCode=" + patientZipCode
				+ ", programCid=" + programCid + ", claimHeaderSid="
				+ claimHeaderSid + ", adjustmentSourceTypeLkpcd="
				+ adjustmentSourceTypeLkpcd + ", admissionDate="
				+ admissionDate + ", admissionHour=" + admissionHour
				+ ", aplctnStatusCid=" + aplctnStatusCid
				+ ", aplctnStatusTypeCid=" + aplctnStatusTypeCid
				+ ", athrztnNmbr=" + athrztnNmbr + ", billDate=" + billDate
				+ ", billTypeFourthDigitLkpcd=" + billTypeFourthDigitLkpcd
				+ ", blngNationalPrvdrIdntfr=" + blngNationalPrvdrIdntfr
				+ ", blngPrvdrFirstName=" + blngPrvdrFirstName
				+ ", blngPrvdrIdntfrTypeCid=" + blngPrvdrIdntfrTypeCid
				+ ", blngPrvdrLastName=" + blngPrvdrLastName
				+ ", blngPrvdrLctnIdentifier=" + blngPrvdrLctnIdentifier
				+ ", blngPrvdrLctnIid=" + blngPrvdrLctnIid
				+ ", blngPrvdrLctnTxnmyCode=" + blngPrvdrLctnTxnmyCode
				+ ", blngPrvdrLegacyId=" + blngPrvdrLegacyId
				+ ", blngPrvdrMiddleName=" + blngPrvdrMiddleName
				+ ", blngPrvdrName=" + blngPrvdrName
				+ ", blngPrvdrSuffixLkpcd=" + blngPrvdrSuffixLkpcd
				+ ", blngPrvdrTypeCode=" + blngPrvdrTypeCode
				+ ", bsnsStatusCid=" + bsnsStatusCid + ", bsnsStatusTypeCid="
				+ bsnsStatusTypeCid + ", chkdoutBy=" + chkdoutBy
				+ ", chkdoutStatusLkpcd=" + chkdoutStatusLkpcd
				+ ", claimSubmissionReasonLkpcd=" + claimSubmissionReasonLkpcd
				+ ", clmSbmtrSid=" + clmSbmtrSid + ", clmSourceCode="
				+ clmSourceCode + ", clmTrnsctnSid=" 
				+ ", clmTypeCid=" + clmTypeCid + ", createdBy=" + createdBy
				+ ", createdDate=" + createdDate + ", currencyTypeLkpcd="
				+ currencyTypeLkpcd + ", denialReasonCd1=" + denialReasonCd1
				+ ", denialReasonCd2=" + denialReasonCd2 + ", dischargeDate="
				+ dischargeDate + ", drgCode=" + drgCode
				+ ", facilityTypeCode=" + facilityTypeCode
				+ ", fromServiceDate=" + fromServiceDate + ", hipaaVersion="
				+ hipaaVersion + ", inbndFileLineNmbr=" + inbndFileLineNmbr
				+ ", insuranceCoverageCode=" + insuranceCoverageCode
				+ ", invoiceTypeLkpcd=" + invoiceTypeLkpcd
				+ ", lastPaymentDate=" + lastPaymentDate + ", lastRunDate="
				+ lastRunDate + ", lastRunNmbr=" + lastRunNmbr
				+ ", lastSuspendDate=" + lastSuspendDate
				+ ", massAdjstmntFlag=" + massAdjstmntFlag + ", mbrIdentifier="
				+ mbrIdentifier + ", mbrIdntfrTypeCid=" + mbrIdntfrTypeCid
				+ ", mbrLegacyIdntfr=" + mbrLegacyIdntfr + ", mbrSid=" + mbrSid
				+ ", medicalRecordNmbr=" + medicalRecordNmbr + ", modifiedBy="
				+ modifiedBy + ", modifiedDate=" + modifiedDate
				+ ", originalTcn=" + originalTcn + ", parentTcn=" + parentTcn
				+ ", patientAccountNmbr=" + patientAccountNmbr
				+ ", patientBirthDate=" + patientBirthDate
				+ ", patientDeathDate=" + patientDeathDate
				+ ", patientFirstName=" + patientFirstName + ", patientGender="
				+ patientGender + ", patientLastName=" + patientLastName
				+ ", patientMiddleName=" + patientMiddleName
				+ ", patientRelationshipLkpcd=" + patientRelationshipLkpcd
				+ ", patientSuffixLkpcd=" + patientSuffixLkpcd
				+ ", primaryDiagnosisIid=" + primaryDiagnosisIid
				+ ", primaryDiagnosisPoaLkpcd=" + primaryDiagnosisPoaLkpcd
				+ ", primaryPaRqstIdentifier=" + primaryPaRqstIdentifier
				+ ", primaryPaRqstSid=" + primaryPaRqstSid
				+ ", primaryRfrlIdntfctnNmbr=" + primaryRfrlIdntfctnNmbr
				+ ", sbmtFcltyBillClsfctnSid=" + sbmtFcltyBillClsfctnSid
				+ ", serviceAthrztnExcptnLkpcd=" + serviceAthrztnExcptnLkpcd
				+ ", specialProgramLkpcd=" + specialProgramLkpcd
				+ ", srvcngNationalPrvdrIdntfr=" + srvcngNationalPrvdrIdntfr
				+ ", srvcngPrvdrFirstName=" + srvcngPrvdrFirstName
				+ ", srvcngPrvdrIdntfrTypeCid=" + srvcngPrvdrIdntfrTypeCid
				+ ", srvcngPrvdrLastName=" + srvcngPrvdrLastName
				+ ", srvcngPrvdrLctnIdentifier=" + srvcngPrvdrLctnIdentifier
				+ ", srvcngPrvdrLctnIid=" + srvcngPrvdrLctnIid
				+ ", srvcngPrvdrLctnTxnmyCode=" + srvcngPrvdrLctnTxnmyCode
				+ ", srvcngPrvdrLegacyId=" + srvcngPrvdrLegacyId
				+ ", srvcngPrvdrMiddleName=" + srvcngPrvdrMiddleName
				+ ", srvcngPrvdrSuffixLkpcd=" + srvcngPrvdrSuffixLkpcd
				+ ", ssbpAthrztnHdrSid=" + ssbpAthrztnHdrSid
				+ ", statusEffectiveDate=" + statusEffectiveDate
				+ ", systemInDate=" + systemInDate + ", tcn=" + tcn
				+ ", tcnDate=" + tcnDate + ", toServiceDate=" + toServiceDate
				+ ", totalBilledAmount=" + totalBilledAmount
				+ ", totalBilledUnit=" + totalBilledUnit + "]";
	}

	public List<HtClmHdrNote> getHtClmHdrNotes() {
		return htClmHdrNotes;
	}

	public void setHtClmHdrNotes(List<HtClmHdrNote> htClmHdrNotes) {
		this.htClmHdrNotes = htClmHdrNotes;
	}
	
	public ClmHdrConflict addClmHdrConflict(ClmHdrConflict clmHdrConflict) {
		getClmHdrConflicts().add(clmHdrConflict);
		clmHdrConflict.setClaimHeader(this);

		return clmHdrConflict;
	}
	...
	public String getBlngPrvdrTaxId() {
		return blngPrvdrTaxId;
	}

	public void setBlngPrvdrTaxId(String blngPrvdrTaxId) {
		this.blngPrvdrTaxId = blngPrvdrTaxId;
	}

	public String getBlngPrvdrTaxIdQlfr() {
		return blngPrvdrTaxIdQlfr;
	}

	public void setBlngPrvdrTaxIdQlfr(String blngPrvdrTaxIdQlfr) {
		this.blngPrvdrTaxIdQlfr = blngPrvdrTaxIdQlfr;
	}
}